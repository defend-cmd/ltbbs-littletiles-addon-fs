...
form preview and in the world. It uses the BBS Block Form corner as its anchor and preserves
the structure's saved LittleTiles origin, so the model does not straddle the block above or
to its right.
